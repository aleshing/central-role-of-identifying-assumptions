...
load("marg_nhoi_fits/pi_tilde_samples.RData")
...
for(j in 1:length(xi)){
    pi_0_temp <- get_pi_0_marg_hoi(pi_tilde_lcmcr, K, list_1 = 2, list_2 = 4, 
                                   xi = xi[j])
    for(i in 1:length(M)){
...
save(N_lcmcr, file = "marg_nhoi_fits/N_samples_sensitivity.RData")
