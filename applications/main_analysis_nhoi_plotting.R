...
# using the no-highest-order interaction assumption
...
N_samples <- N_samples %>% mutate(prior = fct_relevel(prior, rev(priors)))
...
ggsave("plots/main_analysis_nhoi_plot1.pdf", height = 7, width = 8, units = "in")
...
ggsave("plots/main_analysis_nhoi_plot2.pdf", height = 4, width = 8, 
       units = "in")
